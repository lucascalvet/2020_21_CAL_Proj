...
void Menu_old::printTitle(string title) {
...
void Menu_old::printOp(vector<string> options, bool warning, bool enm) {
...
unsigned Menu_old::ProcessarInputInt(vector<string> opcoes, string titulo, unsigned liminf, unsigned limsup) {
    unsigned resposta;
    printTitle(titulo);
...
unsigned Menu_old::ProcessInputInt(vector<string> options, string title) {
...
vector <int> Menu_old::ProcessarIntIndef(string colecao_sing, string colecao_plural, int lim) {
...
template<class T>
vector <int> Menu_old::ProcessarIntIndef(string colecao_sing, string colecao_plural, int lim, list <T> l){
    vector <int> respostas;
    int resp;
...
template<class T>
T Menu_old::InputRestrito(string texto) {
    T resposta;
    cout << endl << texto;
    cin >> resposta;
    while (cin.fail()){
...
string Menu_old::InputNome(string texto) {
    string resposta;
    cout << endl << texto;
...
/*
data Menu_old::InputData(string texto) {
    data resposta;
    int dia, mes, ano;
    bool mespr = false;
...
char Menu_old::InputLetra(string texto) {
    char resp;
    cout << texto;
    cin >> resp;
...
/*
nota_avaliacao Menu_old::InputNota(string texto){
    int respint;
...
template<class T>
bool Menu_old::ProcuraValida(int id, list<T> l) {
    for(auto it = l.begin(); it != l.end(); it++){
...
template<class T>
T Menu_old::EfetuarProcura(int id, list<T> l) {
    for(auto it = l.begin(); it != l.end(); it++){
...
template<class T>
int Menu_old::ProcessarInputProcura(string titulo, list<T> l) {
    int resposta;
    printTitle(titulo);
    PrintList(l);
    cout << "[-X] Voltar" << endl;
...
void Menu_old::Outros() {
    ...
    if (resposta == 5){
        vector<string> topcoes = {"Quartos", "Funcionarios", "Reservas", "Clientes", "Voltar", "Voltar ao Menu_old Principal"};
        ...
        if (membro_ordenar == 0){
            vector<string> q_opcoes = {"Numero Crescente", "Numero Decrescente", "Preco Crescente", "Preco Decrescente", "Voltar", "Voltar ao Menu_old Principal"};
        ...
        if (membro_ordenar == 1){
            vector<string> f_opcoes = {"Cargo", "Salario Crescente", "Salario Decrescente", "Voltar", "Voltar ao Menu_old Principal"};
        ...
        if (membro_ordenar == 2){
            vector<string> r_opcoes = {"Primeira Vez", "Preco Crescente", "Preco Decrescente", "Duracao Crescente", "Duracao Decrescente", "Data Inicial Crescente", "Data Inicial Decrescente", "Data Final Crescente", "Data Final Decrescente", "Voltar", "Voltar ao Menu_old Principal"};
